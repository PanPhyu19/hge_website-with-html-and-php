 ...
 if(isset($_POST['btnsubmit']))
    {
		...
		if (isset($_SESSION['cid']))
		{
			...
			$cid=$_SESSION['cid'];
				...
				$insert="INSERT INTO booking(bookingname,bookingtype,bookingtime,bookingday,customerid)
				values('$name','$type','$time','$day','$cid')";
		...
		<div class="row">
			...
			<div class="wow fadeInUp col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10" data-wow-delay="0.9s">
				...
				<div class="newsletter_detail">
					...
					<select name="txttypes" class="option"> 
					...
					<div class="col-md-4 col-sm-4">
					<select name="txttime" class="option"> 
					...
					<div class="col-md-4 col-sm-4">
					<select name="txtday" class="option"> 
		...
		<div class="row">
			...
			<div id="owl-testimonial" class="owl-carousel">
				...
				<div class="item col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 wow fadeInUp" data-wow-delay="0.6s">
					...
					<h3>I bought home gym equipment from here last month and their service was exceptional.</h3>
					<h4>Michael</h4>
				</div>

				<div class="item col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 wow fadeInUp" data-wow-delay="0.6s">
					<i class="fa fa-quote-left"></i>
					<h3>I had my treadmill repaired by HGE workshop.The technicians there were so professional and fixed my treadmill in less than two days.I will definitely come here again!</h3>
					<h4>Tom</h4>
				</div>

				<div class="item col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 wow fadeInUp" data-wow-delay="0.6s">
					<i class="fa fa-quote-left"></i>
					<h3>The gym equipment from HGE are top-quality.I bought all of the equipment for my gym from this website.</h3>
					<h4>Zackie</h4>
				</div>

				<div class="item col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 wow fadeInUp" data-wow-delay="0.6s">
					<i class="fa fa-quote-left"></i>
					<h3>This website is really trustworthy.I really love their services and high-quality equipment.</h3>
					<h4>Pan</h4>
				</div>
		...
		<div class="row">
			<div class="wow fadeInUp col-md-4 col-sm-4"  data-wow-delay="0.9s">
				<ul class="footer-list">
					<li class="footer-active"><a href="index.php">Home</a></li>
